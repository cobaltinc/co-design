...
const SvgMicOffFill = (props: SVGProps<SVGSVGElement>) => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <g mask="url(#mic-off-fill_svg__a)">
      <path d="M2 2h20v20H2V2Z" fill="currentColor" />
    </g>
    <path fillRule="evenodd" clipRule="evenodd" d="M21.9 4.929 4.93 21.899l-1.414-1.414 16.97-16.97L21.9 4.929Z" fill="currentColor" />
    <path fillRule="evenodd" clipRule="evenodd" d="m20.486 3.515-16.97 16.97-1.414-1.414 16.97-16.97 1.414 1.414Z" fill="#fff" />
  </svg>
);
