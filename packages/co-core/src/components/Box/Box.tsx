...
import { DefaultProps, PolymorphicComponentProps, PolymorphicRef, useSx, useExtractedMargins } from '@co/styles';
...
export const Box: BoxComponent & { displayName?: string } = forwardRef(
  <C extends React.ElementType = 'div'>({ className, component, style, sx, ...others }: BoxProps<C>, ref: PolymorphicRef<C>) => {
