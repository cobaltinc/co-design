...
import { CoTheme, CoComponentProps, PolymorphicComponentProps, PolymorphicRef, useCoTheme, useCss, Co } from '@co-design/styles';
...
View.displayName = '@co-design/primitive/View';
